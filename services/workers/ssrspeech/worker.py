"""SSR-Speech worker: load model once, then consume the ssrspeech queue.
...
from model import SSRSpeechModel

QUEUE_NAME = os.environ.get("QUEUE_NAME", "ssrspeech")
