"""Tortoise-TTS worker: load model once, then consume the tortoise-tts queue.
...
from model import TortoiseModel

QUEUE_NAME = os.environ.get("QUEUE_NAME", "tortoise-tts")
